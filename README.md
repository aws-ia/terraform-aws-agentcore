...
| [aws_iam_policy_document.gateway_policy_merged](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| [aws_iam_policy_document.runtime_policy_merged](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="output_gateway_workload_identity_details"></a> [gateway\_workload\_identity\_details](#output\_gateway\_workload\_identity\_details) | Map of gateway names to their workload identity details (if applicable) |
...
| <a name="output_runtime_workload_identity_details"></a> [runtime\_workload\_identity\_details](#output\_runtime\_workload\_identity\_details) | Map of runtime names to their workload identity details (if applicable) |
